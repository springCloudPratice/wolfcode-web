            ...
            <div class="layui-row layui-col-space10 layui-form-item">
              ...
              <#--  <div class="layui-col-lg6">
                ...
                <div class="layui-col-lg6">
                    ...
                    <div class="layui-input-block">
                        <select name="receiver" id ="linkman">
                            <option value="">请选择</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-col-lg6">
                    ...
                    <div class="layui-input-block">
                        <input type="text"  name="deliverTime" id="contractTime"  placeholder="请输入"  autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-col-lg6">
                        <label class="layui-form-label">收货时间</label>
                    <div class="layui-input-block">
                        <input type="text"  name="receiveTime" id="contractTime1" placeholder="请输入"  autocomplete="off" class="layui-input">
                    </div>
                </div>
...
<script type="text/javascript" src="${request.contextPath}/scripts/user/orderinfo/add.js?_=${randomNum}"></script>
</body>
