    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="user:orderinfo:list">
                        ...
                        <div class="layui-form-item">
                          <div class="layui-inline">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block input-box">
                                    <input type="text"  name="receiveTime" id="contractTime" placeholder="请输入"  autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block input-box">
                                    <input type="text"  name="receiveTime1" id="contractTime1" placeholder="请输入"  autocomplete="off" class="layui-input">
                                </div>
                            </div>
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-toolbar">
                        <div class="layui-btn-container">
                            <@sec.authenticate grants="user:orderinfo:add">
                    ...
                    <script type="text/html" id="List-editBar">
                        <@sec.authenticate grants="user:orderinfo:update">
                            <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="update"><i
                                        class="layui-icon">&#xe642;</i>修改</a>
                        </@sec.authenticate>
                        <@sec.authenticate grants="user:orderinfo:delete">
...
<script type="text/javascript" src="${request.contextPath}/scripts/user/orderinfo/list.js?_=${randomNum}"></script>
</body>
</html>
