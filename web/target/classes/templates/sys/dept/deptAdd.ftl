    ...
    <div class="layui-card-body">
        <form class="layui-form" action="" lay-filter="component-form-element">
            <div class="layui-row layui-col-space10 layui-form-item">
                ...
                <div class="layui-col-lg4">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="deptName" lay-verify="deptName" placeholder="请输入机构名称" autocomplete="off"
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn layui-btn-normal" lay-submit lay-filter="deptAdd-filter">新增</button>
...
<script type="text/javascript" src="${request.contextPath}/static/scripts/sys/dept/deptAdd.js?_=${randomNum}"></script>
</body>