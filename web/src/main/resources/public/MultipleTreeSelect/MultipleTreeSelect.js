...
(function ($) {
    ...
    var init_tree_container = function () {
        ...
        this.tree_container = $('<div   class="menuContent" style="display:none;background-color: white; position: absolute;z-index:110004;border:1px solid #d2d2d2;border-radius: 5px;padding-bottom: 10px" >' +
